...
scene md05_004hazure01d.nss_MAIN
{
...
*/
	...
	if($md05_２週目 == true || $md05_３週目 == true){
		call_scene @->md05_004hazure01d_01.nss;
...
//――――――――――――――――――――――――――――――
.//◆第一段階終了フラグが全てそっていると選択肢出ないで自動的に次ファイルへ
...
scene md05_004hazure01d_01.nss
{
...
//★選択肢シーン
//同行者がいないor基本時
scene md05_004hazure01d.nss_SELECT01
{
//■選択肢前定義
	$構成名 = ModuleFileName();
	$構文名 = $SYSTEM_present_process;
...
scene md05_004hazure01d.nss_SELECT02
{
//■選択肢前定義
	$構成名 = ModuleFileName();
	$構文名 = $SYSTEM_present_process;
...
//★選択肢シーン
//同行者がいないor基本時
scene md05_004hazure01d.nss_SELECT03
{
//■選択肢前定義
	$構成名 = ModuleFileName();
	$構文名 = $SYSTEM_present_process;
