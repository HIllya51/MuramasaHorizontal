...
scene md05_004byoushitsu03ca.nss_MAIN
{
...
scene md05_004byoushitsu03ca.nss
{
...
..//ジャンプ指定
//◆湊斗景明を　"md05_004byoushitsu03caa.nss"
//◆湊斗光を　"md05_004byoushitsu03cab.nss"



//★選択肢シーン
scene md05_004byoushitsu03ca.nss_SELECT
{
//■選択肢前定義
	$構成名 = ModuleFileName();
	$構文名 = $SYSTEM_present_process;
...
//■選択肢
	...
	select
	{
		...
		case @選択肢１
		{
			ChoiceA02();
//◆湊斗景明を　"md05_004byoushitsu03caa.nss"
				$GameName = "md05_004byoushitsu03caa.nss";
		}
		case @選択肢２
		{
			ChoiceB02();
//◆湊斗光を　"md05_004byoushitsu03cab.nss"
				$GameName = "md05_004byoushitsu03cab.nss";
		}
	}
}
